...
var ReactGridLayout = (function(_React$Component) {
  ...
  ReactGridLayout.getDerivedStateFromProps = function getDerivedStateFromProps(
    ...
    if (
      !(0, _lodash2.default)(nextProps.layout, prevState.propsLayout) ||
  ...
  ReactGridLayout.prototype.processGridItem = function processGridItem(
    child,
    isDroppingItem
  ) {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onDragOver = function(e) {
    ...
    if (!_this3.state.droppingDOMNode) {
      _this3.setState({
        droppingDOMNode: _react2.default.createElement("div", {
          key: droppingItem.i
        }),
        droppingPosition: droppingPosition,
        layout: [].concat(layout, [
          _extends({}, droppingItem, {
            x: 0,
            y: 0,
            static: false,
            isDraggable: true
      ...
      var shouldUpdatePosition =
        _this3.state.droppingPosition.x != layerX ||
        _this3.state.droppingPosition.y != layerY;
      shouldUpdatePosition &&
        _this3.setState({ droppingPosition: droppingPosition });
    }
