...
var ResponsiveReactGridLayout = (function(_React$Component) {
  ...
  ResponsiveReactGridLayout.prototype.generateInitialState = function generateInitialState() {
    ...
    var breakpoint = (0, _responsiveUtils.getBreakpointFromWidth)(
      breakpoints,
      width
    );
  ...
  ResponsiveReactGridLayout.getDerivedStateFromProps = function getDerivedStateFromProps(
    nextProps,
    prevState
  ) {
  ...
  ResponsiveReactGridLayout.prototype.componentDidUpdate = function componentDidUpdate(
    ...
    if (
      ...
      !(0, _lodash2.default)(this.props.breakpoints, prevProps.breakpoints) ||
      !(0, _lodash2.default)(this.props.cols, prevProps.cols)
    ) {
   ...
   */
  ResponsiveReactGridLayout.prototype.onWidthChange = function onWidthChange(
    nextProps
  ) {
    ...
    var newBreakpoint =
      ...
      (0, _responsiveUtils.getBreakpointFromWidth)(
        nextProps.breakpoints,
        nextProps.width
      );
    ...
    if (
      ...
      _layout = (0, _utils.synchronizeLayoutWithChildren)(
        _layout,
        nextProps.children,
        newCols,
        compactType
  ...
  ResponsiveReactGridLayout.prototype.render = function render() {
    ...
    var _props2 = this.props,
      ...
      other = _objectWithoutProperties(_props2, [
        "breakpoint",
        "breakpoints",
        "cols",
        "layouts",
